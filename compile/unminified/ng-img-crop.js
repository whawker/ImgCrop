...
},{"./$":45,"./$.fails":23,"./$.iobject":33,"./$.to-object":77}],9:[function(require,module,exports){
...
},{"./$":45,"./$.has":29,"./$.wks":80}],72:[function(require,module,exports){
'use strict';
var ctx                = require('./$.ctx')
  , invoke             = require('./$.invoke')
  , html               = require('./$.html')
...
},{"./$":45,"./$.an-object":3,"./$.def":17,"./$.enum-keys":20,"./$.fails":23,"./$.get-names":27,"./$.global":28,"./$.has":29,"./$.is-array":35,"./$.keyof":46,"./$.library":47,"./$.property-desc":56,"./$.redef":57,"./$.shared":61,"./$.support-desc":70,"./$.tag":71,"./$.to-iobject":75,"./$.uid":78,"./$.wks":80}],167:[function(require,module,exports){
'use strict';
var $            = require('./$')
...
var _cropArea = require('./crop-area');

var _cropArea2 = _interopRequireDefault(_cropArea);

var CropAreaCircle = function CropAreaCircle() {
  _cropArea2['default'].apply(this, arguments);
...
CropAreaCircle.prototype = new _cropArea2['default']();
...
CropAreaCircle.prototype.draw = function () {
  _cropArea2['default'].prototype.draw.apply(this, arguments);
...
exports['default'] = CropAreaCircle;
module.exports = exports['default'];

},{"./crop-area":192}],191:[function(require,module,exports){
'use strict';
...
CropAreaSquare.prototype = new _cropArea2['default']();
...
exports['default'] = CropAreaSquare;
module.exports = exports['default'];

},{"./crop-area":192}],192:[function(require,module,exports){
'use strict';
...
var _cropCanvas = require('./crop-canvas');

var _cropCanvas2 = _interopRequireDefault(_cropCanvas);
...
var CropArea = function CropArea(ctx, events) {
  ...
  this._cropCanvas = new _cropCanvas2['default'](ctx);
...
exports['default'] = CropArea;
module.exports = exports['default'];

},{"./crop-canvas":193}],193:[function(require,module,exports){
'use strict';
...
var square = [[-0.75, -0.75], [-0.75, 0.75], [0.75, 0.75], [0.75, -0.75]];
...
var colors = {
  ...
  resizeCircleStroke: '#df994c',
  resizeCircleFill: '#df994c',
  moveIconFill: '#fff'
};

var cropCanvas = function cropCanvas(ctx) {
  ...
  this.drawIconResizeCircle = function (centerCoords, circleRadius, scale) {
    ...
    //ctx.closePath();
    //ctx.restore();
    drawFilledPolygon(square, colors.resizeCircleFill, centerCoords, scaledCircleRadius);
  };
...
var cropEXIF = function cropEXIF() {
    var debug = false;
...
var _cropAreaCircle = require('./crop-area-circle');

var _cropAreaCircle2 = _interopRequireDefault(_cropAreaCircle);

var _cropAreaSquare = require('./crop-area-square');

var _cropAreaSquare2 = _interopRequireDefault(_cropAreaSquare);

var _cropExif = require('./crop-exif');

var _cropExif2 = _interopRequireDefault(_cropExif);
...
var CropHost = function CropHost(elCanvas, opts, events) {
  /* PRIVATE VARIABLES */
  ...
  this.setNewImageSource = function (imageSource) {
    ...
    if (!!imageSource) {
      ...
      newImage.onload = function () {
        ...
        _cropExif2['default'].getData(newImage, function () {
          var orientation = _cropExif2['default'].getTag(newImage, 'Orientation');
  ...
  this.setAreaType = function (type) {
    ...
    var AreaClass = _cropAreaCircle2['default'];
    if (type === 'square') {
      AreaClass = _cropAreaSquare2['default'];
    }
  ...
  // Init CropArea
  theArea = new _cropAreaCircle2['default'](ctx, events);
...
exports['default'] = CropHost;
module.exports = exports['default'];

},{"./crop-area-circle":190,"./crop-area-square":191,"./crop-exif":194}],196:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, '__esModule', {
  value: true
});
var cropPubSub = function cropPubSub() {
  var events = {};
  // Subscribe
...
var _ngImgCrop = require('./ng-img-crop');

var _ngImgCrop2 = _interopRequireDefault(_ngImgCrop);

window.ImgCrop = _ngImgCrop2['default'];

},{"./ng-img-crop":198}],198:[function(require,module,exports){
'use strict';
...
var _classesCropHost = require('./classes/crop-host');

var _classesCropHost2 = _interopRequireDefault(_classesCropHost);

var _classesCropPubsub = require('./classes/crop-pubsub');

var _classesCropPubsub2 = _interopRequireDefault(_classesCropPubsub);
...
var imgCrop = function imgCrop(element) {
  ...
  // Init Events Manager
  var events = new _classesCropPubsub2['default']();
  // Init Crop Host
  var cropHost = new _classesCropHost2['default'](element.querySelector('canvas'), {}, events);
  ...
  var updateResultImage = function updateResultImage() {
...
},{"./classes/crop-host":195,"./classes/crop-pubsub":196}]},{},[197,188]);
